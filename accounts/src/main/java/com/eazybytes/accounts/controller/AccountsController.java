...
//		throw new TimeoutException();
	...
	/**
	 * The below fallback method as one more number of arguments then the original
	 * method. Like if original method has 2 arguments then fallback method has to
	 * be 3 arguments. The first two will be the same as the original method and the
	 * last argument will be Throwable. If there is no arguments in the original
	 * method then the fallback method will have only one argument which is
	 * Throwable.
	 * 
	 * @param throwable
	 * @return
